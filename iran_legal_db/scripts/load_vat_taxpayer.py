...
def main():
 ...
 try:
  ...
  specs=(
   ...
   (B14,'آیین‌نامه اجرایی ماده ۱۴ مکرر قانون پایانه‌های فروشگاهی و سامانه مؤدیان','آیین‌نامه مؤدیان معاف از صورتحساب','regulation','هیئت وزیران','executive','in_force','2025-01-01','2025-01-01','متن کامل ۱۲ ماده درباره تعیین مالیات مؤدیان معاف از صدور صورتحساب الکترونیکی.'),
   ...
   (BE,'آیین‌نامه اجرایی جزء ۱۴ بند ب ماده ۹ قانون مالیات بر ارزش افزوده','آیین‌نامه معافیت خدمات آموزشی و ورزشی','regulation','هیئت وزیران','executive','in_force','2022-01-18','2022-01-18','متن کامل سه ماده درباره معافیت خدمات آموزشی، پژوهشی و ورزشی دارای مجوز.'),
   (BI,'آیین‌نامه غیرفعال نمودن کارپوشه مؤدیان','آیین‌نامه غیرفعال‌سازی کارپوشه','regulation','هیئت وزیران','executive','in_force','2022-09-04','2022-09-04','متن کامل شش ماده موضوع تبصره ماده ۲۴ قانون ارزش افزوده.'),
