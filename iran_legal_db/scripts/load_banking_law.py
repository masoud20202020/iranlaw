...
def main():
 ...
 try:
  ...
  specs=(
   ...
   (BR,'آیین‌نامه تجهیز منابع پولی موضوع فصل دوم قانون عملیات بانکی بدون ربا','آیین‌نامه تجهیز منابع پولی','regulation','هیئت وزیران','executive','in_force','1983-12-18','1984-03-21','متن کامل ۱۲ ماده درباره سپرده قرض‌الحسنه و سپرده سرمایه‌گذاری مدت‌دار.'),
   (BF,'آیین‌نامه تسهیلات اعطایی بانکی موضوع فصل سوم قانون عملیات بانکی بدون ربا','آیین‌نامه تسهیلات بانکی','regulation','هیئت وزیران','executive','amended','1984-01-04','1984-03-21','متن تلفیقی ۹۰ ماده؛ عقود قرض‌الحسنه، مشارکت، مضاربه، سلف، فروش اقساطی، اجاره به شرط تملیک، جعاله، مزارعه، مساقات، استصناع، مرابحه و خرید دین.'),
