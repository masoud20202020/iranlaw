...
def main():
 ...
 try:
  ...
  specs=(
   ...
   (AISA,'آیین‌نامه اجرایی تبصره ۲ اصلاحی ماده ۵ قانون ثبت احوال','آیین‌نامه همکاری در ثبت وقایع حیاتی','regulation','هیأت وزیران','executive','in_force',DREG_BY,'متن کامل ۱۴ ماده درباره اعلام ولادت و وفات، فاقدان شناسنامه، روستاها و تبادل الکترونیکی.'),
   ...
   (AINM,'آیین‌نامه اجرایی قانون الزام اختصاص شماره ملی و کدپستی','آیین‌نامه شماره ملی و کدپستی','regulation','هیأت وزیران','executive','in_force',DNID_BY,'متن کامل ۱۴ ماده درباره کارت شناسایی، پایگاه جمعیت و کاربرد شماره ملی و کدپستی.'),
   (AKNM,'آیین‌نامه کاربردی شدن کارت شناسایی ملی','کاربرد کارت شناسایی ملی','regulation','هیأت وزیران','executive','in_force',DAPPLIED,'متن کامل ده ماده درباره احراز هویت و ارائه خدمات بر مبنای کارت ملی.'),
   (AISM,'آیین‌نامه اجرایی کارت هوشمند ملی چندمنظوره با اصلاحات','آیین‌نامه کارت هوشمند ملی','regulation','هیأت وزیران','executive','amended',DSMART,'سیزده ماده؛ ماده ۱۳ الحاقی ۱۴۰۰ درباره اعلام تمایل به اهدای عضو.'),
   ...
   (AITF,'آیین‌نامه اعطای تابعیت ایران به فرزندان حاصل از ازدواج زنان ایرانی با مردان خارجی','آیین‌نامه تابعیت فرزندان','regulation','هیأت وزیران','executive','in_force',DCIT_BY,'متن کامل ۲۴ ماده درباره احراز نسب، استعلام امنیتی، شناسنامه، کارت ملی و رسیدگی داخل و خارج کشور.'),
   ...
   (AIPZ,'آیین‌نامه اجرایی پروانه گذر زیارتی','آیین‌نامه پروانه گذر زیارتی','regulation','هیأت وزیران','executive','in_force',DZI,'متن کامل یازده ماده موضوع بند ۱ ماده ۲۹ قانون گذرنامه.'),
  )
