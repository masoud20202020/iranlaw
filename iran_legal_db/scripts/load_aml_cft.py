...
def main():
 ...
 try:
  ...
  specs=(
   ...
   (AB,'آیین‌نامه اجرایی مقابله و پیشگیری از جرایم پولشویی و تأمین مالی تروریسم با اصلاحات ۱۴۰۴','آیین‌نامه جامع AML/CFT','regulation','هیئت وزیران','executive','amended','2019-10-13','2019-10-14','متن جاری تلفیقی ۱۶۴ ماده و چهار ماده مکرر؛ عنوان و ساختار اصلاحی ۱۴۰۴.'),
   (EAB,'اصلاح آیین‌نامه اجرایی ماده ۱۴ الحاقی قانون مبارزه با پولشویی','اصلاحیه آیین‌نامه AML/CFT ۱۴۰۴','amendment','هیئت وزیران','executive','in_force','2025-10-19','2025-11-05','متن کامل ۵۷ بند اصلاحی؛ مبنای عنوان جدید و شماره‌گذاری جاری.'),
   (AOLD,'آیین‌نامه اجرایی قانون مبارزه با پولشویی مصوب ۱۳۸۸ (منسوخ)','آیین‌نامه قدیم پولشویی','regulation','هیئت وزیران','executive','abrogated','2009-02-11','2009-02-11','متن کامل ۴۹ ماده صرفاً تاریخی؛ آیین‌نامه جاری ۱۴۰۴ منسوخ بودن آن را تصریح می‌کند.'),
   ...
   (COLD,'آیین‌نامه اجرایی قانون مبارزه با تأمین مالی تروریسم مصوب ۱۳۹۶ (منسوخ)','آیین‌نامه قدیم CFT','regulation','هیئت وزیران','executive','abrogated','2017-10-29','2017-10-29','متن کامل ۳۰ ماده؛ به موجب ماده ۳۰ آیین‌نامه اقدام مالی هدفمند منسوخ شد.'),
   (TARGET,'آیین‌نامه اجرایی اقدام مالی هدفمند علیه تروریسم و تأمین مالی تروریسم با اصلاحات ۱۴۰۵','آیین‌نامه اقدام مالی هدفمند','regulation','هیئت وزیران','executive','amended','2025-11-12','2025-11-12','۳۰ ماده جاری و ماده ۳۱ تاریخی؛ اصلاحات جاری تا ۱۴۰۵/۰۳/۳۱.'),
   (FIU,'آیین‌نامه تشکیلات مرکز اطلاعات مالی','آیین‌نامه مرکز اطلاعات مالی','regulation','هیئت وزیران','executive','amended','2019-09-04','2019-09-07','هشت ماده؛ ماده ۴ به علت محدودیت دسترسی مستقیم، خلاصه ساختاری منبع‌دار فهرست ۲۶ وظیفه است و رونوشت لفظ‌به‌لفظ محسوب نمی‌شود.'),
  ...
  oldids=seq(c,docs[AOLD],AOLD,AML_OLD_BYLAW,'2009-02-11',SRC_AOLD,False,'2019-10-14')
  cftids={};cftcur={}
