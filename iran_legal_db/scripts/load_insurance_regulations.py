...
def main():
    ...
    try:
        ...
        specs = (
            ...
            (R100, "آیین‌نامه شماره ۱۰۰ ضوابط تأسیس و فعالیت مؤسسات بیمه غیردولتی", "آیین‌نامه مؤسسات بیمه غیردولتی", "regulation", "شورای عالی بیمه", "oversight", "in_force", None, None, "متن کامل ۲۱ ماده؛ جایگزین آیین‌نامه شماره ۴۰ و مکمل‌های آن."),
        ...
        arts[R100] = add_rows(conn, docs[R100], R100, PRIVATE_INSURANCE_100, None, "متن کامل آیین‌نامه شماره ۱۰۰؛ بازنشر دادگران بیمه خراسان.")
